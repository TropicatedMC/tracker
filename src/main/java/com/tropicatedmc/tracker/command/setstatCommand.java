...
public class setstatCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if(!sender.hasPermission("tracker.setstat")) {
        ...
        if (args.length == 3) {
            ...
            plugin.getCommandUtils().setStatistic(gPlayer, statistic, value);
            sender.sendMessage(Tracker.formatMsg("MESSAGES.STATISTIC_SET")
        ...
        sender.sendMessage(Tracker.colourize("&cUsage: /setstatistic <player> <statistic> <value>"));
        return true;
    }
}